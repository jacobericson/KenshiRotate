...
static const char* g_translations[LANG_COUNT][TR_COUNT] = {
	...
	{ "Mittlere Maustaste", "Warnung: belegt mit '", "'",
	  ...
	  "Drehen nicht m\xc3\xb6glich: nicht genug Platz" },                                                               // Drehen nicht möglich: nicht genug Platz
	// LANG_FR — French
	...
	{ "Bot\xc3\xa3o do meio do mouse",                                                                                  // Botão do meio do mouse
	  ...
	  "N\xc3\xa3o \xc3\xa9 poss\xc3\xadvel rotacionar: espa\xc3\xa7o insuficiente" }                                   // Não é possível rotacionar: espaço insuficiente
};
